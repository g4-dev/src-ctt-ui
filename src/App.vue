  ...
  <v-app :style="{ background: $vuetify.theme.themes[theme].background }">
    ...
    >
      <div class="d-flex align-center">
        ...
        <v-toolbar-title>Call2Text</v-toolbar-title>
      </div>

      <v-spacer></v-spacer>

      <v-btn link to="/logout" text>
    ...
    <v-navigation-drawer v-model="drawer" app clipped="true">
      <v-list-item two-line :class="miniVariant && 'px-0'">
        ...
        <v-list-item-content>
          <v-list-item-title>Ayush P Gupta</v-list-item-title>
          <v-list-item-subtitle>GA</v-list-item-subtitle>
          <v-list-item-subtitle>RaspIT</v-list-item-subtitle>
        </v-list-item-content>
      </v-list-item>
      ...
      <v-list dense nav>
        <v-subheader>Transcripts</v-subheader>
        <v-list-item link to="/">
          <v-list-item-icon>
        ...
        <v-list-item link>
          <v-list-item-icon>
            <v-icon>la-file-alt</v-icon>
          </v-list-item-icon>

          <v-list-item-content>
            <v-list-item-title>View/Download Reports</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        <v-list-item link>
          <v-list-item-icon>
          ...
          <v-list-item-content>
            <v-list-item-title>Doctor Visit</v-list-item-title>
          </v-list-item-content>
          <v-chip x-small color="indigo" text-color="white">New</v-chip>
        </v-list-item>
        <v-list-item link>
          <v-list-item-icon>
            <v-icon>la-file-alt</v-icon>
          ...
          <v-list-item-content>
            <v-list-item-title>Lead Visit</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
      </v-list>
    </v-navigation-drawer>
